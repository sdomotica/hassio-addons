# Sdomotica Gateway for F460 integration by cloud
...
### Integrate your BTicino F460 into Home Assistant

![Scs2][scs2]
![Scs3][scs3]

## English
Sdomotica is a gateway using official Home + Control API to integrate on Home Assistant.

The integration expose as mqtt services all items of your F460 scs bus home system.

Here the [manual][manuale] for configure the addon

## Italiano
Sdomotica è un gateway che utilizza le API ufficiali Home + Controllo per integrare
il vostro impianto che utilizza F460 in Home Assistant.
